...
import heroBg from '@/assets/hero-bg-loss-income.jpg';
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-red-900 to-red-700 text-white py-20 relative overflow-hidden">
          <div
            className="absolute inset-0 opacity-30 pointer-events-none"
            style={{ backgroundImage: `url(${heroBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
            aria-hidden="true"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/55 to-red-700/40 pointer-events-none" aria-hidden="true" />
