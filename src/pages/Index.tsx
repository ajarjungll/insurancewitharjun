  ...
  const insuranceTypes = [
    {
      ...
      features: ["Collision Coverage", "Comprehensive Coverage", "Liability Protection", "Rental Car Coverage"]
    },
    {
      icon: <Home className="w-12 h-12 text-blue-600" />,
      title: "Home Insurance",
      description: "Protect your home and belongings with our comprehensive homeowner's insurance.",
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {insuranceTypes.map((type, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <Link
                  to="/quote"
                  className="block mt-6 bg-blue-600 text-white text-center py-2 rounded-lg hover:bg-blue-700 transition-colors"
                >
                  Get Quote
                </Link>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose Sharnjit Insurance Hut?</h2>
