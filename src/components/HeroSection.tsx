        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl mb-8 text-blue-100">
              Over 25 years of experience providing comprehensive insurance solutions. 
              From auto to home, life to business - we've got you covered.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/contact"
                className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-900 transition-colors text-center"
              >
                Contact Agent
              </Link>
            </div>
